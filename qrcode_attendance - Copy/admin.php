...
<body>
    ...
    <script>
        ...
        function onScanSuccess(decodedText, decodedResult) {
            ...
            // Send data to the server including the student ID and event type
            fetch("record_attendance.php", {
                method: "POST",
                headers: { "Content-Type": "application/x-www-form-urlencoded" },
                body: `student_id=${encodeURIComponent(decodedText)}&typeofevent=${encodeURIComponent(eventType)}`
            })
